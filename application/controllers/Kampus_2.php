...
class Kampus_2 extends CI_Controller {
	...
	public function index()
	{
		...
		$data['izin'] =$this->Kampus2_model->getAllData()->result_array();
		$data['title'] = 'Perizinan Santri Kampus 2';
		$this->load->view('templates/header',$data);
		$this->load->view('templates/sidebar',$data);
		$this->load->view('templates/topbar',$data);
		$this->load->view('kampus2/index',$data);
		$this->load->view('templates/footer',$data);
	}

	public function add(){
		$db4 = $this->load->database('database_kampus2', TRUE);
		$data['user'] = $this->db->get_where('user',['email' =>$this->session->userdata('email')])->row_array();
		$data['title'] = 'Tambah Perizinan Santri';
		$data['santri'] = $db4->get('siswa')->result_array();
		$this->load->view('templates/header',$data);
		$this->load->view('templates/sidebar',$data);
		$this->load->view('templates/topbar',$data);
		$this->load->view('kampus2/add',$data);
		$this->load->view('templates/footer',$data);
	}
	...
	public function izin($id_santri){
		...
		$data['user'] = $this->db->get_where('user',['email' =>$this->session->userdata('email')])->row_array();
		$data['title'] = 'Tambah Perizinan Santri';
		$data['santri'] = $db4->get_where('siswa',$id)->row_array();
		$this->load->view('templates/header',$data);
		$this->load->view('templates/sidebar',$data);
		$this->load->view('templates/topbar',$data);
		$this->load->view('kampus2/izin',$data);
		$this->load->view('templates/footer',$data);
	}
	...
	public function izin_aksi(){
		...
		if($this->form_validation->run() == false){
			...
			$this->db->insert('santri_kampus_2',$data);
	...
	public function detail($id_santri){
		...
		$data['santri'] = $this->db->get_where('santri_kampus_2',$id)->row_array();
		$this->load->view('templates/header',$data);
		$this->load->view('templates/sidebar',$data);
		$this->load->view('templates/topbar',$data);
		$this->load->view('kampus2/detail',$data);
		$this->load->view('templates/footer',$data);
	}
	...
	public function editIzin($id_santri){
		...
		$this->load->view('templates/sidebar',$data);
		$this->load->view('templates/topbar',$data);
		$this->load->view('kampus2/edit_izin',$data);
		$this->load->view('templates/footer',$data);
	}
	...
	public function editIzin_aksi(){
		...
		$this->db->update('santri_kampus_2',$data);
	...
	public function delIzin($id_santri){
		$id =['id' =>$id_santri];
		$this->db->where($id);
		$this->db->delete('santri_kampus_2'); 
	...
	public function verify($id_santri){
		if($this->session->userdata('role_id') == 1){
			...
			$this->db->update('santri_kampus_2');
			$this->index();
...
// 	// Data Santri ============================================================================================================================
	...
	public function editSantri($id_santri){
		...
		$this->load->view('templates/sidebar',$data);
		$this->load->view('templates/topbar',$data);
		$this->load->view('kampus2/edit_santri',$data);
		$this->load->view('templates/footer',$data);
	}
...
// 	// submenu masa izin ===============================================================================================================
	...
	public function masaIzin()
	{
		...
		$data['izin'] =$this->Kampus2_model->getAllDataMasaIzin()->result_array();
		$data['title'] = 'Masa Izin Kampus 2';
		$this->load->view('templates/header',$data);
		$this->load->view('templates/sidebar',$data);
		$this->load->view('templates/topbar',$data);
		$this->load->view('kampus2/masa_izin',$data);
		$this->load->view('templates/footer',$data);
	}	
...
// 	// submenu masa izin ===============================================================================================================
	...
	{
		$data['user'] = $this->db->get_where('user',['email' =>$this->session->userdata('email')])->row_array();
		$data['izin'] =$this->Kampus2_model->getAllDataLog()->result_array();
		$data['title'] = 'Log Perizinan Kampus 2';
		$this->load->view('templates/header',$data);
		$this->load->view('templates/sidebar',$data);
		$this->load->view('templates/topbar',$data);
		$this->load->view('kampus2/log',$data);
		$this->load->view('templates/footer',$data);
	}	
}