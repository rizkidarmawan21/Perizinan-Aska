...
// class Kampus_4 extends CI_Controller {
...
// 		// Load database kedua
// 		$this->load->database('database_kampus1', TRUE);
...
class Kampus_4 extends CI_Controller {
	...
	public function index()
	{
		...
		$data['izin'] =$this->Kampus4_model->getAllData()->result_array();
		$data['title'] = 'Perizinan Santri Kampus 4';
		$this->load->view('templates/header',$data);
		$this->load->view('templates/sidebar',$data);
		$this->load->view('templates/topbar',$data);
		$this->load->view('kampus4/index',$data);
		$this->load->view('templates/footer',$data);
	}

	public function add(){
		$db2 = $this->load->database('database_kampus4', TRUE);
		$data['user'] = $this->db->get_where('user',['email' =>$this->session->userdata('email')])->row_array();
		...
		$this->load->view('templates/sidebar',$data);
		$this->load->view('templates/topbar',$data);
		$this->load->view('kampus4/add',$data);
		$this->load->view('templates/footer',$data);
	}
	...
	public function izin($id_santri){
		...
		$data['user'] = $this->db->get_where('user',['email' =>$this->session->userdata('email')])->row_array();
		$data['title'] = 'Tambah Perizinan Santri';
		$data['santri'] = $db2->get_where('siswa',$id)->row_array();
		$this->load->view('templates/header',$data);
		$this->load->view('templates/sidebar',$data);
		$this->load->view('templates/topbar',$data);
		$this->load->view('kampus4/izin',$data);
		$this->load->view('templates/footer',$data);
	}
	...
	public function izin_aksi(){
		...
		if($this->form_validation->run() == false){
			...
			$this->db->insert('santri_kampus_4',$data);
	...
	public function detail($id_santri){
		...
		$data['santri'] = $this->db->get_where('santri_kampus_4',$id)->row_array();
		$this->load->view('templates/header',$data);
		$this->load->view('templates/sidebar',$data);
		$this->load->view('templates/topbar',$data);
		$this->load->view('kampus4/detail',$data);
		$this->load->view('templates/footer',$data);
	}
	public function editIzin($id_santri){
		...
		$this->load->view('templates/sidebar',$data);
		$this->load->view('templates/topbar',$data);
		$this->load->view('kampus4/edit_izin',$data);
		$this->load->view('templates/footer',$data);
	}
	...
	public function editIzin_aksi(){
		...
		$this->db->update('santri_kampus_4',$data);
	...
	public function delIzin($id_santri){
		$id =['id' =>$id_santri];
		$this->db->where($id);
		$this->db->delete('santri_kampus_4'); 
	...
	public function printKeluar($id_santri){
        $data['user'] = $this->db->get_where('user',['email' =>$this->session->userdata('email')])->row_array();
        $id= ['id'=>$id_santri];
			$data['title'] = 'Print Perizinan Keluar';
			$data['santri'] = $this->db->get_where('santri_kampus_4',$id)->row_array();
			$this->load->view('print/print_keluar',$data);
	...
	public function verify($id_santri){
		if($this->session->userdata('role_id') == 1 ){
			...
			$this->db->update('santri_kampus_4');
			$this->index();
		} elseif($this->session->userdata('role_id') == 14){
			$this->db->set('status',1);
			$this->db->where('id',$id_santri);
...
// 	Data Santri ============================================================================================================================
	...
	public function editSantri($id_santri){
		...
		$this->load->view('templates/sidebar',$data);
		$this->load->view('templates/topbar',$data);
		$this->load->view('kampus4/edit_santri',$data);
		$this->load->view('templates/footer',$data);
	}
...
// 	submenu masa izin ===============================================================================================================
	...
	public function masaIzin()
	{
		...
		$data['izin'] =$this->Kampus4_model->getAllDataMasaIzin()->result_array();
		$data['title'] = 'Masa Izin Kampus 4';
		$this->load->view('templates/header',$data);
		$this->load->view('templates/sidebar',$data);
		$this->load->view('templates/topbar',$data);
		$this->load->view('kampus4/masa_izin',$data);
		$this->load->view('templates/footer',$data);
	}	
...
// 	submenu masa izin ===============================================================================================================
	public function log()
	{
		...
		$data['izin'] =$this->Kampus4_model->getAllDataLog()->result_array();
		$data['title'] = 'Log Perizinan Kampus 4';
		$this->load->view('templates/header',$data);
		$this->load->view('templates/sidebar',$data);
		$this->load->view('templates/topbar',$data);
		$this->load->view('kampus4/log',$data);
		$this->load->view('templates/footer',$data);
	}	
}