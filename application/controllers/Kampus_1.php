...
class Kampus_1 extends CI_Controller {
	...
	public function index()
	{
		...
		$data['izin'] =$this->Kampus1_model->getAllData()->result_array();
		$data['title'] = 'Perizinan Santri Kampus 1';
		$this->load->view('templates/header',$data);
		$this->load->view('templates/sidebar',$data);
		$this->load->view('templates/topbar',$data);
		$this->load->view('kampus1/index',$data);
		$this->load->view('templates/footer',$data);
	}

	public function add(){
		$db2 = $this->load->database('database_kampus1', TRUE);
		$data['user'] = $this->db->get_where('user',['email' =>$this->session->userdata('email')])->row_array();
		...
		$this->load->view('templates/sidebar',$data);
		$this->load->view('templates/topbar',$data);
		$this->load->view('kampus1/add',$data);
		$this->load->view('templates/footer',$data);
	}
	...
	public function izin($id_santri){
		...
		$this->load->view('templates/sidebar',$data);
		$this->load->view('templates/topbar',$data);
		$this->load->view('kampus1/izin',$data);
		$this->load->view('templates/footer',$data);
	}
	...
	public function izin_aksi(){
		...
		if($this->form_validation->run() == false){
			...
			$this->db->insert('santri_kampus_1',$data);
	...
	public function detail($id_santri){
		...
		$data['santri'] = $this->db->get_where('santri_kampus_1',$id)->row_array();
		$this->load->view('templates/header',$data);
		$this->load->view('templates/sidebar',$data);
		$this->load->view('templates/topbar',$data);
		$this->load->view('kampus1/detail',$data);
		$this->load->view('templates/footer',$data);
	}
	public function editIzin($id_santri){
		...
		$this->load->view('templates/sidebar',$data);
		$this->load->view('templates/topbar',$data);
		$this->load->view('kampus1/edit_izin',$data);
		$this->load->view('templates/footer',$data);
	}
	...
	public function editIzin_aksi(){
		...
		$this->db->update('santri_kampus_1',$data);
	...
	public function delIzin($id_santri){
		$id =['id' =>$id_santri];
		$this->db->where($id);
		$this->db->delete('santri_kampus_1'); 
	...
	public function verify($id_santri){
		if($this->session->userdata('role_id') == 1){
			...
			$this->db->update('santri_kampus_1');
			$this->index();
		}
	...
	public function editSantri($id_santri){
		...
		$this->load->view('templates/sidebar',$data);
		$this->load->view('templates/topbar',$data);
		$this->load->view('kampus1/edit_santri',$data);
		$this->load->view('templates/footer',$data);
	}
	...
	{
		$data['user'] = $this->db->get_where('user',['email' =>$this->session->userdata('email')])->row_array();
		$data['izin'] =$this->Kampus1_model->getAllDataMasaIzin()->result_array();
		$data['title'] = 'Masa Izin Kampus 1';
		$this->load->view('templates/header',$data);
		$this->load->view('templates/sidebar',$data);
		$this->load->view('templates/topbar',$data);
		$this->load->view('kampus1/masa_izin',$data);
		$this->load->view('templates/footer',$data);
	}	
	...
	{
		$data['user'] = $this->db->get_where('user',['email' =>$this->session->userdata('email')])->row_array();
		$data['izin'] =$this->Kampus1_model->getAllDataLog()->result_array();
		$data['title'] = 'Log Perizinan Kampus 1';
		$this->load->view('templates/header',$data);
		$this->load->view('templates/sidebar',$data);
		$this->load->view('templates/topbar',$data);
		$this->load->view('kampus1/log',$data);
		$this->load->view('templates/footer',$data);
	}	
}