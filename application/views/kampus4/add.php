					...
					foreach ($santri as $s) : ?>
						<tr>
							...
							<td style="text-align: center;">
								<h5> <a href="<?= base_url('kampus_4/editSantri/' . $s['id']); ?>" class="badge badge-pill badge-secondary">Edit</a>
									<a href="<?= base_url('kampus_4/izin/' . $s['id']); ?>" class="badge badge-pill badge-success">Izin</a>
								</h5>
							</td>
						</tr>
					<?php endforeach; ?>
