...
<tr>
    <td>Tgl  Izin <br>' . date('d F Y', $santri['tgl_ijin']) . '</td>
    <td >Tgl Kembali <br>' . date('d F Y', strtotime($santri['tgl_kembali'])) . '</td>
...
<li>Durasi Santri Izin Sesuai Dari Pihak Pesantren,Bila Melampui Batas akan dikenai <b>DENDA</b>.</li>
